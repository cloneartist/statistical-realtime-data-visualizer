...
public class CustomerServiceImp implements CustomerService {
	...
	public Customer saveCustomer(Customer customer) {
		...
		//Checking whether the given customer already exist in the customer repository , in case if the same customer customer exists
		...
		countryService.AggregateCountryDataOrAddCountry(customer.getCountry(),customer.getCredit_score(),customer.getEstimated_salary());
