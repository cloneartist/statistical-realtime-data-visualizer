...
const Monitor = () =>{
    return (
        ...
        <div className="col-4">
            ...
            <div>
                    <MonitorCard  url="ingestion/sent_log" name="sent log" packet_status="sent" title="Sent From Ingestion Service"></MonitorCard>
                    <img className='sendimg' src='https://cdn-icons-png.flaticon.com/512/4697/4697980.png'></img>
                    <MonitorCard  url="analytics/receive_log" name="receive log" packet_status="received" title="Received By Analytics Service"></MonitorCard>
                    </div>
        </div>
             <div className="col-4">
