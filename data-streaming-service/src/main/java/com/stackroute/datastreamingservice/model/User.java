package com.stackroute.datastreamingservice.model;
public class User {
...
public String toString() {
	return "User [customer_id=" + customer_id + ", credit_score=" + credit_score + ", country=" + country + ", gender="
 + gender + ", age=" + age + ", tenure=" + tenure + ", balance=" + balance + ", products_number="
 + products_number + ", credit_card=" + credit_card + ", active_member=" + active_member
 + ", estimated_salary=" + estimated_salary + ", churn=" + churn + "]";
}
}